...
if(isset($_POST['submit'])){
	...
	$sql="insert into `hod_leave`(leave_id,leave_from,leave_to,employee_id,leave_description,leave_status,role,employee_name,department_id,alternate,email) values('$leave_id','$leave_from','$leave_to','$employee_id','$leave_description',1,'$role','$employee_name','$department_id','$alternate','$email')";
