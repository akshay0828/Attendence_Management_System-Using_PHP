...
if(isset($_POST['submit'])){
	...
	$sql="insert into `faculty_leave`(leave_id,leave_from,leave_to,employee_id,leave_description,leave_status,role,department_id,employee_name,email,alternate) values('$leave_id','$leave_from','$leave_to','$employee_id','$leave_description',1,'2',$department_id,'$employee_name','$email','$alternate')";
