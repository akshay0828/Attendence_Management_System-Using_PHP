...
$res=mysqli_query($con,"select * from employee where role=3 order by id desc");
?>
                              ...
                              <table class="table ">
                                 ...
                                 <tbody>
									...
									<tr>
									   ...
									   <td><a href="add_employee2.php?id=<?php echo $row['id']?>">edit </a> <a href="employee2.php?id=<?php echo $row['id']?>&type=delete">Delete</a></td>
                                    </tr>
									<?php 
									$i++;
									} ?>
