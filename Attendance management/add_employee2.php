...
if(isset($_POST['submit'])){
	...
	if($id>0){
		...
		$sql="insert into employee(name,email,mobile,password,department_id,address,birthday,role,image,designation) values('$name','$email','$mobile','$password','$department_id','$address','$birthday','2','$image','$designation')";
	}
                        ...
                        <div class="card-body card-block">
                           <form method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
									...
									<input type="file" value="<?php echo $image?>" name="image" placeholder="Enter employee image" class="form-control" >
								</div>
