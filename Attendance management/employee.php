...
{
case '4':$res=mysqli_query($con,"select * from employee where department_id=4 and role=2 order by designation desc");
break;
                              ...
                              <table class="table ">
                                 ...
                                 <tbody>
									...
									<td><?php echo $row['designation']?></td>
									   ...
									   <td><a href="hod_profile.php?id=<?php echo $row['id']?>">view</a> <a href="add_employee2.php?id=<?php echo $row['id']?>">Edit</a> <a href="employee.php?id=<?php echo $row['id']?>&type=delete">Delete</a></td>
                                    </tr>
									<?php 
									$i++;
									} ?>
